...
if (mercadopago_1.default.config) {
    mercadopago_1.default.config.access_token = env_1.env.MP_ACCESS_TOKEN;
}
else {
    mercadopago_1.default.access_token = env_1.env.MP_ACCESS_TOKEN;
}
exports.payment = new mercadopago_1.Payment(mercadopago_1.default);
